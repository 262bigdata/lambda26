...
- captura del producer y consumer de `ec-eventos-py`
...
```powershell
docker compose -f uso-microserv/ec-pago-ms/compose-dev.yml down
docker compose -f uso-microserv/ec-orden-ms/compose-dev.yml down
docker compose -f uso-rapido/ec-eventos-py/compose.yml down
